...
результат по девяти пунктам ремесленного качества: разнообразие
синтаксиса, смесь длины предложений, отсутствие штампов, уместные образы,
неровный ритм, начало абзацев не с подлежащего, живые переходы, звучание
при чтении вслух, сохранность сюжета. Десятый пункт (объём текста в
пределах ±10% от оригинала) сервис считает сам, а не спрашивает у модели.

В чек-лист намеренно не включены количественные пороги из технического
задания (доля предложений с подлежащего, коэффициент вариации длины,
процент уникальных слов и т.п.) — это статистические признаки, на которые
ориентируются детекторы ИИ-текста. Сервис остаётся инструментом
литературной правки, а не инструментом обхода конкретных детекторов;
