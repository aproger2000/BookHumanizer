"""
Chapter Editor v3.7.3 — чешская цепочка (cs) + расширенные точечные замены
"""
import json
import os
import re
...
def minimal_clean(text: str) -> str:
    ...
    cs_specific_fixes = [
        ...
        # Чешские артефакты
        (r'Доконче и упрощен океан', 'Хоть посреди океана'),
        (r'Алеслон на возвращении в страну Месице', 'Хоть на обратной стороне Луны'),
        ...
        (r'Фурри', 'Шегги'),
        (r'Стерн', 'Штерн'),
        (r'Мистер Стерн', 'Мистер Штерн'),
        (r'господин Стерн', 'господин Штерн'),
        # Реплики
        ...
        (r'— Что это такое', '— Что это'),
        # Чешские фразы в диалогах
        (r'Ибис', '«Ибис»'),
        (r'ибис', '«Ибис»'),
        # Удаление бессмысленных чешских вставок
        (r'\b[A-Za-zčřžýáíéůúěňťď]+ [A-Za-zčřžýáíéůúěňťď]+ [A-Za-zčřžýáíéůúěňťď]+ [A-Za-zčřžýáíéůúěňťď]+\b', ''),
